...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__90C6F31",
    appName: "WuHanJournal",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
function initRuntimeSocketService() {
  const hosts = "10.204.152.2,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_-qq4sT";
...
const tabBar = {
  ...
  list: [
    ...
    },
    {
      ...
      text: "导航",
      iconPath: "static/tabbar/route.png",
      selectedIconPath: "static/tabbar/route-active.png"
    },
    {
...
const b = true, E = "mp-weixin", A = T(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), P = E, C = T('{"address":["127.0.0.1","10.204.152.2"],"servePort":7000,"debugPort":9000,"initialLaunchType":"local","skipFiles":["<node_internals>/**","E:/liulanqi_xiazai/HBuilderX.4.76.2025082103 (1)/HBuilderX/plugins/unicloud/**/*.js"]}'), O = T('[{"provider":"aliyun","spaceName":"whlthw","spaceId":"mp-ef975975-5c03-4eeb-9a1f-bf947b6bfd51","clientSecret":"69w0ZXD4xPx3VU2RTijVQQ==","endpoint":"https://api.next.bspapp.com"}]') || [];
let N = "";
try {
  N = "__UNI__90C6F31";
} catch (e2) {
